...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="{{asset('imagens/gti news logo home.png')}}" alt="logo">
        GTI News   
      </a>
              ...
              <form class="space-y-4 md:space-y-6" action="{{route('logar')}}" method="post">
                ...
                @endif
                  ...
                  <div class="flex items-center justify-between">
                      <div class="flex items-start">
                          ...
                          <div class="ml-3 text-sm">
                            <label for="remember" class="text-gray-500 dark:text-gray-300">Lembrar minha Senha</label>
                          </div>
                      </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                     Não Criou Sua Conta Ainda? <a href="{{route('telaCadastro')}}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Crie Sua Conta</a>
                  </p>
              </form>
          </div>
      </div>
